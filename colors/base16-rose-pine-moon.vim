...
if has("nvim")
  ...
  let g:terminal_color_14 = "#ea9a97"
...
call <sid>hi("DiagnosticUnderlineError", "", "", "", "", "undercurl", s:gui08)
call <sid>hi("DiagnosticWarn", s:gui09, "", s:cterm09, "", "", "")
call <sid>hi("DiagnosticUnderlineWarn", "", "", "", "", "undercurl", s:gui09)
call <sid>hi("DiagnosticInfo", s:gui0A, "", s:cterm0A, "", "", "")
call <sid>hi("DiagnosticUnderlineInfo", "", "", "", "", "undercurl", s:gui0A)
call <sid>hi("DiagnosticHint", s:gui0B, "", s:cterm0B, "", "", "")
call <sid>hi("DiagnosticUnderlineHint", "", "", "", "", "undercurl", s:gui0B)
